...
<div class="w3-container w3-margin w3-card-4">
    ...
    <div class="w3-container">
        <form enctype="multipart/form-data" action="<?php echo htmlspecialchars(base_url() . "admin/usuario/password/$idusuario") ?>" method = "POST">
            
            <p>
                <input type = "password" title="Nueva Password" id="c4" name = "p1" maxlength="20" placeholder = "Nueva Password" class="w3-input w3-border" /></p>
            <p>
