...
<header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i><?php echo $titulo ?></b></h5>
</header>
<!--fin header-->
...
<div class="w3-row-padding w3-margin-bottom">
    <div class="w3-third">
        <div class="w3-container w3-blue w3-padding-16">
            ...
            <div class="w3-right">
                <h3><?php echo $inmuebles["numero"] ?></h3>
            </div>
            <div class="w3-clear"></div>
            <h4>Total Inmuebles</h4>
        </div>
    </div>
    <div class="w3-third">
        <div class="w3-container w3-teal w3-padding-16">
            ...
            <div class="w3-right">
                <h3><?php echo $disponible["numero"] ?></h3>
            </div>
            <div class="w3-clear"></div>
    ...
    <div class="w3-third">
        <div class="w3-container w3-red w3-padding-16">
            ...
            <div class="w3-right">
                <h3><?php echo $nodisponible["numero"] ?></h3>
            </div>
            <div class="w3-clear"></div>
            <h4>Inmuebles No Dispobibles</h4>
        </div>
    </div>
