...
<div class="w3-container w3-margin-right w3-margin-left">
    <h2 class="w3-panel w3-blue-grey w3-card-4">Publicar Inmueble</h2>
    <div class="w3-container">
        <div class="w3-container">
            <form enctype="multipart/form-data" onsubmit="return formInmuebleSet()" action="<?php echo htmlspecialchars(RUTA . "inmueble/set") ?>" method = "POST">
                ...
                <p>
                    <input type = "text" title="Barrio" maxlength="28" required="" name = "c7" placeholder = "Barrio"   class="w3-input w3-border"/>
                </p>
                ...
                <p>
                    <input type = "file" id="c15" name = "c15[]" multiple="" required="" class="w3-input w3-border" />
                    <span style="color: red" >*Máximo 20 archivos con extensión .jpg y máximo 2MB por carga</span>
                </p>

                <h3 class="w3-panel w3-blue w3-card-4" >Propietario</h3>
                <p>
                    <select title="Cliente" name = "c16" id="c16" class="w3-input w3-border" >
                        <option value="SGInmobiliar">SGInmobiliar</option>
                    </select>
                </p>
