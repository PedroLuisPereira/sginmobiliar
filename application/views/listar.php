                ...
                <div class="row  align-items-end">
                    <div class="col-md-3">
                        ...
                        <div class="select-wrap">
                            ...
                            <select name="tipo" id="tipo" class="form-control d-block rounded-0">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="select-wrap">
                            <span class="icon icon-arrow_drop_down"></span>
                            <select name="oferta" id="oferta" class="form-control d-block rounded-0">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="select-wrap">
                            <span class="icon icon-arrow_drop_down"></span>
                            <select name="ciudad" id="ciudad" class="form-control d-block rounded-0">
            ...
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="property-entry horizontal d-lg-flex">
                        ...
                        <a href="<?php echo base_url() . 'front/detalles/' . $value['idinmueble'] ?>" class="property-thumbnail h-100">
                            ...
                            <img src="<?php echo base_url() ?>uploads/<?php echo $value['foto'] ?>" style="height: 380px; width: auto;display:block; margin: auto" alt="Image">
                        </a>

                        <div class="p-4 property-body">
                            <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                            <h2 class="property-title"><a href="#"><?php echo $value['ciudad'] ?></a></h2>
            ...
            <div class="col-md-12 text-center">
                <div class="site-pagination">
                    <?php for ($i = 0; $i < $paginas; $i++): ?>
                        <a href="<?php echo base_url() ."listar/?p=".($i + 1).$cadena?>" <?php if($numero == $i+1) echo 'class="active"'  ?> ><?php echo $i + 1 ?></a>
                    <?php endfor; ?>
                </div>
            </div>  
        </div>
